...
namespace SurvivalTemplatePro
{
    ...
    public class Interactable : MonoBehaviour, IInteractable
    {
        ...
        [Tooltip("Interactable description, shows up in the UI when looking at an objec")]
        ...
        {
            InteractionText = this.GetType().Name.DoUnityLikeNameFormat();
        }
