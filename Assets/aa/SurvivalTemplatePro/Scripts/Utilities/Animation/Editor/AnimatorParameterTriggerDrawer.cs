...
namespace SurvivalTemplatePro
{
	...
	public class AnimatorParameterTriggerDrawer : PropertyDrawer
	{
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
            ...
            STPEditorGUI.Separator(new Rect(separatorX, position.y - 1f, position.width + k_Indentation / 2, 1f));
            ...
            if (paramType == AnimatorControllerParameterType.Bool)
            {
                ...
                bool boolean = Mathf.Approximately(m_ValueProp.floatValue, 0f) ? false : true;
            ...
            STPEditorGUI.Separator(new Rect(separatorX, position.yMax + EditorGUIUtility.standardVerticalSpacing - 1f, position.width + k_Indentation / 2, 1f));
        }
        ...
        private AnimatorController GetAnimatorController(SerializedProperty property)
        {
            ...
            if (anim == null)
                component.transform.parent.GetComponentInChildren<Animator>();
