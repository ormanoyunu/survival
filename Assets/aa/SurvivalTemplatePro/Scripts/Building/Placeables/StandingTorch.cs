...
{
    public class StandingTorch : Interactable
    {
        [BHeader("General (Torch)")]
        ...
        [SerializeField]
        [Tooltip("Fire light effect compone")]
        ...
        public void EnableFire(bool enableFire)
        {
            ...
            DescriptionText = enableFire ? m_DisableFireText : m_EnableFireText;
